...
class TritonPythonModel:
    """Cancel-aware passthrough for the SAM2.1 large encoder (fp32 variant).

    Benchmarking twin of sam2.1_large_encoder (which wraps the fp16 model) --
    same cancel-aware BLS passthrough, pointed at the fp32
    sam2.1_large_encoder_onnx instead, so the two can be compared through an
    identical wrapper/ensemble shape.
